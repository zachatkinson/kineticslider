...
import { createBrandedNumber, SlideIndex as _SlideIndex } from '../types/branded';
...
export const useKineticSlider = ({
  ...
  const [currentSlide, setCurrentSlide] = useState<number>(initialSlide as unknown as number);
