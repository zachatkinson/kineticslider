...
describe('AutoPlayManager', () => {
  ...
  describe('handleInteraction()', () => {
    it('should pause on interaction', () => {
      ...
      expect(manager.getState().pauseReasons).toContain(PauseReason.INTERACTION);
    });
    ...
    it('should auto-resume after delay', async () => {
      ...
      expect(resumedSpy).toHaveBeenCalledWith({ reason: PauseReason.INTERACTION });
      expect(manager.getState().pauseReasons).not.toContain(PauseReason.INTERACTION);
    });
